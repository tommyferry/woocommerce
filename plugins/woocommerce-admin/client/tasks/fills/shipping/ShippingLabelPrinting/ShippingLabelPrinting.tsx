	...
	return (
		<div className="woocommerce-task-shipping-shipping-label-printing">
			<div className="shipping-label-printing-row">
				<div className="shipping-label-printing-row-col-left shipping-label-printing-col">
					<img src={ BannerImage } alt="woocommerce shipping" />
				</div>
				<div className="shipping-label-printing-row-col-right shipping-label-printing-col">
					<div className="row">
